...
function Sidebar() {
  ...
  return (
    <aside className="flex flex-col gap-3 md:p-4 md:gap-6 background-color-white rounded-2xl sm:p-2 min-height-screen max-width-full sm:max-width-xs">
      <div className="flex items-center justify-between sm:flex-row md:flex-col md:gap-5">
        <div className="flex justify-center w-[100px] md:w-full">
          <Logo />
        </div>
        {isModalOn && (
        ...
        {user?.role === "teacher" && (
          <div className="flex flex-row items-center justify-center gap-1 p-2 transition-all duration-300 ease-in-out padding-4 background-color-orange-50 rounded-2xl">
